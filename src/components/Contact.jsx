...
export default function Contact() {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(135deg, #1e2730 0%, #2d3848 100%)" }}
    >
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-5">
            Trabajemos
            <br />
            <span className="text-[#ea5959]">juntos.</span>
          </h2>
        ...
        <div className="flex-1 w-full">
          {sent ? (
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-[#ea5959] hover:bg-[#d64a4a] text-white font-bold py-4 rounded-xl transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 tracking-widest text-sm"
              >
                ENVIAR MENSAJE
              </button>
            </form>
