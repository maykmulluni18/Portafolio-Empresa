...
const stats = [
  { value: "30+", label: "Proyectos exitosos",    icon: "🏆" },
    ...
    <div className="w-full bg-white pt-20 pb-20 px-4">
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        ...
        <p className="text-center text-[1.15rem] md:text-[1.3rem] text-[#35404d] leading-relaxed mb-14 max-w-3xl">
          ...
          <span className="text-[#e8524b] font-bold">Nombre Empresa</span> — una Agencia de{" "}
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6 mb-20">
          {stats.map(({ value, label, icon }) => (
            <div
              key={label}
              className="flex flex-col items-center p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow bg-gradient-to-br from-white to-gray-50"
            >
        ...
        <div className="text-center">
          ...
          <h3 className="text-4xl md:text-5xl font-black text-[#35404d] tracking-tight mb-4">
            Nuestros Servicios
          </h3>
